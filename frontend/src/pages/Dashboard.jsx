          ...
          <div className="flex gap-2 items-center">
            ...
            {(role === "instructor" ||
              ...
              <button
                ...
                className="bg-[#5c3d00] text-white px-5 py-2 rounded-full text-sm font-medium hover:bg-[#7a5200]"
              >
                Analytics
              </button>
            )}
...
function CourseCard({
  ...
  const tag =
    course.tag || "not-started";

  return (
    <div
      className={`bg-[#fffdf5] rounded-2xl border border-gray-200 overflow-hidden flex ${
        view === "list"
          ? "flex-row"
          : "flex-col"
      }`}
    >
      ...
      <div
        className={`p-5 flex justify-between ${
          view === "list"
            ? "w-48 items-center justify-center"
            : ""
        }`}
        style={{
          background:
      ...
      >
        ...
        {view === "grid" && (
          <span
            className={`text-xs px-2 py-1 rounded-full ${TAG_STYLES[tag]}`}
          >
            {TAG_LABELS[tag]}
          </span>
        )}
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <button
            onClick={onContinue}
            className="flex-1 py-2 rounded-lg text-sm bg-[#5c3d00] text-white"
          >
            Continue
          </button>
          ...
          {(role === "instructor" ||
            ...
            <button
              ...
              className="px-3 py-2 border border-[#d4a017] text-[#5c3d00] text-sm rounded-lg hover:bg-[#fff3cd]"
            >
              Edit
            </button>
          )}
